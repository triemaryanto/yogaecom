...
<html lang="en">
    <head>
        ...
        <link
            rel="icon"
            href="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/images/dashboard/favicon.png"
            type="image/x-icon"
        />
        <link
            rel="shortcut icon"
                ...
                <div class="main-header-right row">
                    <div class="main-header-left d-lg-none w-auto">
                        <div class="logo-wrapper">
                            <a href="index.html">
                                <img
                                    class="blur-up lazyloaded d-block d-lg-none"
                                    src="{{
                                        asset('/multikart_all_in_one/back-end/')
                    ...
                    <div class="nav-right col">
                        <ul class="nav-menus">
                            ...
                            <li class="onhover-dropdown">
                                ...
                                <span class="dot"></span>
                                <ul
                                    class="notification-dropdown onhover-show-div p-0"
                                >
                                    <li>
                                        Notification
                                        <span
                                            class="badge badge-pill badge-primary pull-right"
                                            >3</span
                                        >
                                    </li>
                                    <li>
                            ...
                            <li class="onhover-dropdown">
                                <div class="media align-items-center">
                                    <img
                                        ...
                                        src="{{
                                            asset(
                                                '/multikart_all_in_one/back-end/'
                                            )
                                        }}/assets/images/dashboard/user3.jpg"
                                        alt="header-user"
                                    />
            ...
            <div class="page-body-wrapper">
                ...
                <div class="page-sidebar">
                        ...
                        <div class="logo-wrapper">
                            <a href="index.html">
                                <img
                                    ...
                                    src="{{
                                        asset('/multikart_all_in_one/back-end/')
                                    }}/assets/images/dashboard/multikart-logo.png"
                                    alt=""
                                />
                            </a>
                        </div>
                    ...
                    <div class="sidebar custom-scrollbar">
                        <a
                            href="javascript:void(0)"
                            class="sidebar-back d-lg-none d-block"
                                    ...
                                    <ul class="list">
                                        <li class="clearfix">
                                            <img
                                                ...
                                                }}/assets/images/dashboard/user.jpg"
                                                alt=""
                                            />
                                            <div
                                        ...
                                        <li class="clearfix">
                                            <img
                                                ...
                                                }}/assets/images/dashboard/user1.jpg"
                                                alt=""
                                            />
                                            <div
                                        ...
                                        <li class="clearfix">
                                            <img
                                                ...
                                                }}/assets/images/dashboard/user2.jpg"
                                                alt=""
                                            />
                                            <div
                                                class="status-circle online"
                                        ...
                                        <li class="clearfix">
                                            <img
                                                ...
                                                }}/assets/images/dashboard/user5.jpg"
                                                alt=""
                                            />
                                            <div
                                                class="status-circle away"
                            ...
                            <div class="col-xxl-3 col-md-6 xl-50">
                                <div class="card o-hidden widget-cards">
                                    <div class="warning-box card-body">
                                        <div
                                            class="media static-top-widget align-items-center"
                                        >
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            ...
                                            >
                                                <li>
                                                    <i
                                                        class="icofont icofont-simple-left"
                                                    ></i>
                                                </li>
                                                <li>
                                                    <i
                                                        class="view-html fa fa-code"
                                                    ></i>
                                                </li>
                                                <li>
                                                    <i
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="code-box-copy">
                                            ...
                                            >
                                                <i
                                                    class="icofont icofont-copy-alt"
                                                ></i>
                                            </button>
                                            ...
                                            <div class="col-6">
                                                <div class="value-graph">
                                                    <h3>
                                                        ...
                                                        <span
                                                            ><i
                                                                class="fa fa-angle-up font-primary"
                                                            ></i
                                                        ></span>
                                                    </h3>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="value-graph">
                                                    <h3>
                                                        ...
                                                        <span
                                                            ><i
                                                                class="fa fa-angle-up font-secondary"
                                                            ></i
                                                        ></span>
                                                    </h3>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="value-graph">
                                                    <h3>
                                                        ...
                                                        <span
                                                            ><i
                                                                class="fa fa-angle-up font-warning"
                                                            ></i
                                                        ></span>
                                                    </h3>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="value-graph">
                                                    <h3>
                                                        ...
                                                        <span
                                                            ><i
                                                                class="fa fa-angle-up font-danger"
                                                            ></i
                                                        ></span>
                                                    </h3>
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body sell-graph">
                                        ...
                                        <div class="code-box-copy">
                                            ...
                                            <pre
                                                class="language-html"
                                            ><code class=" language-html" id="example-head3"><div class="card-body sell-graph">
   <canvas id="myGraph"></canvas>
</div></code></pre>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 xl-100">
                                <div class="card height-equal">
                                    ...
                                    <div class="card-body">
                                        <div
                                            class="user-status table-responsive products-table"
                                        >
                                            <table
                                                class="table table-bordernone mb-0"
                                            >
                                                <thead>
                                                    <tr>
                                                        <th scope="col">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td
                                                            class="bd-t-none u-s-tb"
                                                        >
                                                            <div
                                                                class="align-middle image-sm-size"
                                                            >
                                                                <img
...
<div class="user-status table-responsive products-table">
        ...
        <tbody>
                <tr>
                    <td class="bd-t-none u-s-tb">
                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('/multikart_all_in_one/back-end/') }}/assets/images/dashboard/user2.jpg" alt="" data-original-title="" title="">
            ...
            <tr>
                <td class="bd-t-none u-s-tb">
                    <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('/multikart_all_in_one/back-end/') }}/assets/images/dashboard/user1.jpg" alt="" data-original-title="" title="">
                    <div class="d-inline-block">
            ...
            <tr>
                <td class="bd-t-none u-s-tb">
                    <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('/multikart_all_in_one/back-end/') }}/assets/images/dashboard/user3.jpg" alt="" data-original-title="" title="">
                    <div class="d-inline-block">
            ...
            <tr>
                <td class="bd-t-none u-s-tb">
                    <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('/multikart_all_in_one/back-end/') }}/assets/images/dashboard/user.jpg" alt="" data-original-title="" title="">
                    <div class="d-inline-block">
            ...
            <tr>
                <td class="bd-t-none u-s-tb">
                    <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('/multikart_all_in_one/back-end/') }}/assets/images/dashboard/designer.jpg" alt="" data-original-title="" title="">
                    <div class="d-inline-block">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div
                                                class="col-xl-3 col-sm-6 xl-50"
                                            >
                                                <div class="order-graph">
                                                    <h6>Orders By Location</h6>
                                                    <div
                                                        class="chart-block chart-vertical-center"
                                                    >
                                                        <canvas
                                                            id="myDoughnutGraph"
                                                        ></canvas>
                                                    ...
                                                    <div
                                                        class="order-graph-bottom"
                                                    >
                                                        <div class="media">
                                                            <div
                                                                class="order-color-primary"
                                                            ></div>
                                                            <div
                                                                class="media-body"
                                                            >
                                            ...
                                            >
                                                <div
                                                    class="order-graph sm-order-space"
                                                >
                                                    <h6>Sales By Location</h6>
                                                    <div
                                                        class="peity-chart-dashboard text-center"
                                                    >
                                                        <span
                                                            class="pie-colours-1"
                                                            >4,7,6,5</span
                                                    ...
                                                    <div
                                                        class="order-graph-bottom sales-location"
                                                    >
                                                        <div class="media">
                                                            <div
                                                                class="order-shape-primary"
                                                            ></div>
                                                            <div
                                                                class="media-body"
                                                            >
   ...
   <div class="col-xl-6 xl-100">
      <div class="order-graph xl-space">
        ...
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/jquery-3.3.1.min.js"></script>
        ...
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/icons/feather-icon/feather.min.js"></script>
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/icons/feather-icon/feather-icon.js"></script>

        <!-- Sidebar jquery-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/sidebar-menu.js"></script>

        <!--chartist js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/chart/chartist/chartist.js"></script>

        <!--chartjs js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/chart/chartjs/chart.min.js"></script>

        <!-- lazyload js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/lazysizes.min.js"></script>

        <!--copycode js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/prism/prism.min.js"></script>
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/clipboard/clipboard.min.js"></script>
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/custom-card/custom-card.js"></script>

        <!--counter js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/counter/jquery.waypoints.min.js"></script>
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/counter/jquery.counterup.min.js"></script>
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/counter/counter-custom.js"></script>

        <!--peity chart js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/chart/peity-chart/peity.jquery.js"></script>
        ...
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/chart/sparkline/sparkline.js"></script>

        <!--Customizer admin-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/admin-customizer.js"></script>

        <!--dashboard custom js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/dashboard/default.js"></script>

        <!--right sidebar js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/chat-menu.js"></script>

        <!--height equal js-->
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/height-equal.js"></script>
        ...
        <script src="{{
                asset('/multikart_all_in_one/back-end/')
            }}/assets/js/admin-script.js"></script>
    </body>
</html>
