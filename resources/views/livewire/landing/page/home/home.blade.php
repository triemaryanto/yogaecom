<div>
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="{{ asset('multikart_all_in_one/') }}/assets/images/home-banner/1.jpg" alt=""
            ...
            <div>
                <div class="home text-center">
                    <img src="{{ asset('multikart_all_in_one/') }}/assets/images/home-banner/2.jpg" alt=""
                        class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{ asset('multikart_all_in_one/') }}/assets/images/sub-banner1.jpg"
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{ asset('multikart_all_in_one/') }}/assets/images/sub-banner2.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                    ...
                    <div class="product-4 product-m no-arrow">
                            ...
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/27.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/28.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html">
                                        <img src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/1.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/33.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/34.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/35.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('multikart_all_in_one/') }}/assets/images/pro3/36.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="{{ asset('multikart_all_in_one/') }}/assets/images/parallax/1.jpg" alt=""
                class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="slide-3 no-arrow slick-default-margin">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('multikart_all_in_one/') }}/assets/images/blog/1.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('multikart_all_in_one/') }}/assets/images/blog/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('multikart_all_in_one/') }}/assets/images/blog/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('multikart_all_in_one/') }}/assets/images/blog/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset('multikart_all_in_one/') }}/assets/images/blog/5.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                ...
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/slider/2.jpg"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/slider/3.jpg"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="fa fa-instagram"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/slider/4.jpg"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="fa fa-instagram"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/slider/9.jpg"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="fa fa-instagram"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/slider/6.jpg"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="fa fa-instagram"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/slider/7.jpg"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="fa fa-instagram"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/slider/8.jpg"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="fa fa-instagram"></i></div>
                                </div>
                            </a>
                    ...
                    <div class="slide-6 no-arrow">
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/1.png"
                                        alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/2.png"
                                        alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/3.png"
                                        alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/4.png"
                                        alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/5.png"
                                        alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/6.png"
                                        alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/7.png"
                                        alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img
                                        src="{{ asset('multikart_all_in_one/') }}/assets/images/logos/8.png"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
